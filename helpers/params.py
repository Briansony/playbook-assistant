...
# TODO: if mode is not specified default is default
...
add_parser.add_argument('-t', '--task', choices=('create', 'add'), required=True, help='Task name')
add_parser.add_argument('-n', '--name', action='store', required=True, help='Name of playbook')
add_parser.add_argument('-r', '--roles', nargs='+', required=True, help='List of roles')
